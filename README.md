...
The main issue might even be FAT formatting. If it would just be the SPI device I'm writing to, I might aswell also write my own library. I won't do FAT (16/32) though.
...
The mesurements do not really show real-world scenarios. They just write to the sd-card.
